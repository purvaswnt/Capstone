...
# Age histogram
ggplot(data=adult, aes(adult$SRAGE_P)) + geom_histogram()


# BMI histogram
ggplot(data=adult, aes(adult$BMI_P)) + geom_histogram(binwidth = 1)
...
DF = table(RBMI = adult$RBMI,SRAGE_P = adult$SRAGE_P)
is.matrix(DF)
as.data.frame(DF)
